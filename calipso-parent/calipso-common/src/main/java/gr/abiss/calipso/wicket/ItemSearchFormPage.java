...
public class ItemSearchFormPage extends BasePage {        
    ...
    public ItemSearchFormPage() {
        ...
        ItemSearchFormPanel itemSearchFormPanel = new ItemSearchFormPanel("panel", breadCrumbBar);
        add(itemSearchFormPanel);
        breadCrumbBar.setActive(itemSearchFormPanel);
    ...
    public ItemSearchFormPage(ItemSearch itemSearch) {
        ...
        //panels that change with navigation
        ItemSearchFormPanel itemSearchFormPanel = new ItemSearchFormPanel("panel", breadCrumbBar, itemSearch);
        add(itemSearchFormPanel);
        breadCrumbBar.setActive(itemSearchFormPanel);
    }    
