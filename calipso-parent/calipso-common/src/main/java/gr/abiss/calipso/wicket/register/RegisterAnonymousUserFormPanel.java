...
public class RegisterAnonymousUserFormPanel extends BasePanel {
    ...
    public RegisterAnonymousUserFormPanel(String id, IBreadCrumbModel breadCrumbModel) {  
    ...
    private class UserForm extends Form {
        ...
        */
        ...
        //	add an empty Panel to the page
            // TODO:
            formFragment = new Fragment("organizationContainer","emptyFragment", RegisterAnonymousUserFormPanel.this);
        			...
        			protected void onSelectionChanged(Object newSelection) {
        				...
        				if(tmpOrg == null || getDefaultModelObjectAsString().equals("")){
    						...
    						// clear organization domain <-> email domain validator
       						...
       						Fragment newEmptyFragment = new Fragment("organizationContainer","emptyFragment", RegisterAnonymousUserFormPanel.this);
