...
public class PositiveNumberValidator extends AbstractValidator{
	private String resourceKey = "PositiveNumberValidator";
	

	public PositiveNumberValidator() {
	}

	public PositiveNumberValidator(String resourceKey) {
