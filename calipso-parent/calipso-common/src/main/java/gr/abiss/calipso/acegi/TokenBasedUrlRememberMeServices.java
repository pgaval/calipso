...
public class TokenBasedUrlRememberMeServices extends TokenBasedRememberMeServices{
	
	/**
	 * Please make proper use of logging, see http://www.owasp.org/index.php/Category:Logging_and_Auditing_Vulnerability
	 */
	private static final Logger logger = Logger.getLogger(TokenBasedUrlRememberMeServices.class);
