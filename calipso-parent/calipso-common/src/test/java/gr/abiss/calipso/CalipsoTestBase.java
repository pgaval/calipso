 ...
 */
public abstract class CalipsoTestBase extends AbstractTransactionalDataSourceSpringContextTests {
    
    protected CalipsoService calipsoService;
    protected CalipsoDao dao;
    
    public CalipsoTestBase() {
        System.setProperty("calipsoService.home", "target/home");
    }
    ...
    //  magically autowired by Spring JUnit support
    public void setCalipso(CalipsoService calipsoService) {
